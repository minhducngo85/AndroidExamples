...
public class CompassView extends View {
    ...
    /**
     * to decode the measure specification
     * 
     * @param measureSpec
     *            the measure specification
     * @return the screen related size
     */
    private int measure(int measureSpec) {
        ...
        if (specMode == MeasureSpec.UNSPECIFIED) {
            // the default size of 200 if no bounds are specified
            result = 200;
        } else {
            // return the full available bound
            result = specSize;
        }
        return result;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF innerBoundingBox = new RectF(center.x - radius + ringWidth, center.y - radius + ringWidth, center.x + radius - ringWidth, center.y
                + radius - ringWidth);
